          ...
          <div className="p-5">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg font-poppins text-sm text-red-600 transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <LogOut size={18} />
          ...
          <div className="p-4 h-full overflow-y-auto">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <button
                ...
                disabled={isLoggingOut}
                className="w-full flex items-center gap-2 px-3 py-2 rounded-lg font-poppins text-xs text-red-600 transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <LogOut size={16} />
                <span>{isLoggingOut ? "Logging out..." : "Logout"}</span>
              </button>
